...
/******/ 	__webpack_require__.p = "/afierst22/portfolio/";
/******/
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return biography; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "c", function() { return skills; });
var projects=[{title:"Hansel and Gretel: A Modern Retelling",subtitle:"HTML and CSS",description:"A narrative website created by using HTML and CSS. I wanted to take a classic Grimm Brother's fairy tale and reimagine it in a modern way.",image:"./project-hanselgretel.gif",link:"https://dtc-wsuv.org/afierst22/narrative/"},{title:"Divinity: Original Sin 2 Mod",subtitle:"Divinity Engine",description:"A mod made using Larian Studios' Divinity Engine. Inspired by my love for the Harry Potter series, I wanted to bring some of its characters to life in a new way.",image:"./project-mod.gif",link:"#projects"},{title:"Weather App",subtitle:"HTML, CSS, and OpenWeatherMap API",description:"A weather application made with HTML and CSS using the OpenWeatherMap API. Demonstrating my ability to learn and apply an API in a practical way. ",image:"./project-weatherapp.gif",link:"https://dtc-wsuv.org/afierst22/weather/"},{title:"Logistic Regression Model",subtitle:"Python, Scikit-Learn, Pandas",description:"A logistic regression model that uses a dataset of League of Legends matches to learn how to predict if a game will be won based on a variety of features.",image:"./project-machinelearning.gif",link:"#projects"},{title:"Knight Runner",subtitle:"JavaScript and Canvas",description:"An \"endless runner\" game made using Canvas and JavaScript. My first programming project that uses sprites and animations. Give it a try!",image:"./project-canvasgame.gif",link:"https://dtc-wsuv.org/afierst22/canvas-game/"},{title:"Personal Project",subtitle:"Unreal Engine 5",description:"This project is a personal one that I am using to learn the ins-and-outs of Unreal Engine 5. I one day hope to finish it as a single-player RPG.",image:"./project-ue5.gif",link:"#projects"}];var biography=[{quote:"I was born and raised in Vancouver, WA. Prior to starting my journey at Washington State University, I served for 4 years in the United States Army. Growing up I was always tinkering with anything and everything to learn about how things worked. It's a habit I don't think I'll ever outgrow, as today I find myself passionate about programming - determined to develop web applications and games. ",image:"./profile.jpg",name:"Austin Fierst",company:"WSU Vancouver"}];var skills=["JavaScript","React","HTML","CSS","Python 3","C++","Unreal Engine","Unity"];
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = Biography;
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_react__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__heroicons_react_solid__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__data__ = __webpack_require__(4);
function Biography(){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("section",{id:"biography"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"container px-5 py-10 mx-auto text-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__heroicons_react_solid__["f" /* UsersIcon */],{className:"w-10 inline-block mb-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("h1",{className:"sm:text-4xl text-3xl font-medium title-font text-white mb-12"},"Bio"),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"flex flex-center m-4"},__WEBPACK_IMPORTED_MODULE_2__data__["a" /* biography */].map(function(biography){return __WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"p-4 w-full"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"h-full bg-gray-800 bg-opacity-40 p-8 rounded"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement(__WEBPACK_IMPORTED_MODULE_1__heroicons_react_solid__["e" /* TerminalIcon */],{className:"block w-8 text-gray-500 mb-4"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("p",{className:"leading-relaxed mb-6 w-3/4 mx-auto"},biography.quote),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("div",{className:"inline-flex items-center"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("img",{alt:"aboutme",src:biography.image,className:"w-12 rounded-full flex-shrink-0 object-cover object-center"}),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"flex-grow flex flex-col pl-4"},__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"title-font font-medium text-white"},biography.name),__WEBPACK_IMPORTED_MODULE_0_react___default.a.createElement("span",{className:"text-gray-500 text-sm uppercase"},biography.company)))));}))));}

/***/ })
/******/ ]);
//# sourceMappingURL=main.cc8b7915.js.map